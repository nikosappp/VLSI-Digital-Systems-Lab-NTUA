...
architecture behavioral of control_unit is
    ...
    -- FIX: Adjusted the max range of delay_cnt just to be safe, though not strictly required
...
begin
    ...
    -- (This logic correctly handles the pipeline drain when valid_in goes low!)
                    ...
                    case state is
                        ...
                        when LOADING =>
                            ...
                            if delay_cnt = (N) then
                                state     <= RUNNING;
                                valid_out <= '1';
                                -- CHANGE 2: Start col_cnt at 0 instead of 1 to correctly flag the first pixel
                                col_cnt   <= 0; 
                            else
